...
cluster::cluster(int siteId1, int * neighId1, double * neighRates1,int sizen1, int visitFreq1,
int siteId2, int * neighId2, double * neighRates2,int sizen2, int visitFreq2){
