...
int main(void){
  ...
  cout << "Test 2" << endl;
  {
    ...
    site_container.addSite(site3);
    site_container.addSite(site4);
    site_container.addSite(site5);
    site_container.addSite(site6);
    site_container.addSite(site7);
    site_container.addSite(site8);
    site_container.addSite(site9);
    site_container.addSite(site10);
    site_container.addSite(site11);
    site_container.addSite(site12);
    site_container.addSite(site13);
    site_container.addSite(site14);
    site_container.addSite(site15);
    site_container.addSite(site16);
