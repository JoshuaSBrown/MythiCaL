...
#include "../../libkmccoarsegrain/kmc_dynamic_topology.hpp"
...
//    unordered_map<int, double> neigh_rates_site2;
   ...
   // KMC_Cluster_Container clusters;
    ...
    topology.setRates(rates);
    // Create the sites
    topology.features[1].feature(topology,1);
    topology.features[2].feature(topology,2);
    topology.features[3].feature(topology,3);
    topology.features[4].feature(topology,4);

    BasinExplorer basin_explorer; 
    auto vertices = basin_explorer.findBasin(topology,2);
...
/*    unordered_map<int,double> site_10_rates;
    ...
    rates[10][6]=rate10_6;
    rates[10][9]=rate10_9;
    rates[10][11]=rate10_11;
    rates[10][14]=rate10_14;

    double rate11_7 = fast*1.5;
...
*/
    rates[11][7]=rate11_7;
    rates[11][10]=rate11_10;
    rates[11][12]=rate11_12;
    rates[11][15]=rate11_15;
...
/*    unordered_map<int,double> site_12_rates;
    ...
    rates[12][8]=rate12_8;
    rates[12][11]=rate12_11;
    rates[12][16]=rate12_16;
...
/*    unordered_map<int,double> site_13_rates;
  ...
  /*  unordered_map<int,double> site_14_rates;
    ...
    rates[14][10]=rate14_10;
    rates[14][13]=rate14_13;
    rates[14][15]=rate14_15;
...
/*    unordered_map<int,double> site_15_rates;
    ...
    rates[15][11]=rate15_11;
    rates[15][14]=rate15_14;
    rates[15][16]=rate15_16;
...
/*    unordered_map<int,double> site_16_rates;
    ...
    rates[16][12]=rate16_12;
    rates[16][15]=rate16_15;
...
/*    KMC_Site site1;
   ...
   /* 
    ...
    // Create the sites
//    for(int siteId=1;siteId<17;++siteId){
...
//    KMC_Cluster_Container clusters;
    ...
    auto vertices = basin_explorer.findBasin(topology,6);
    ...
    vertices = basin_explorer.findBasin(topology,7);
    ...
    vertices = basin_explorer.findBasin(topology,11);
    assert(vertices.size()==3);
