#ifndef KMCCOARSEGRAIN_KMC_CLUSTER_HPP
#define KMCCOARSEGRAIN_KMC_CLUSTER_HPP
...
namespace kmccoarsegrain {
  ...
  class KMC_Cluster {
    ...
    public:
      ...
      KMC_Cluster(const KMC_Cluster & KMC_Cluster);
      ...
      /// Must be copy so I can call unique
      void addSites(std::vector<int> site_ids);
    ...
    private:
      ...
      struct CrudePtrs{
        ...
        std::unordered_map<int,double> * time_constants = nullptr;	
